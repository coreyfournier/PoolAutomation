...
Invoke-Expression -Command "pscp -r -pw $($password) PoolAutomation.tar  $($computer):/home/pi"
...
# Invoke-Expression -Command "pscp -r -pw $($password) www\apexcharts\*.*  $($computer):$($targetPath)www/apexcharts"
